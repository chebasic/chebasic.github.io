...
var subtitleFormat = function (percent) {
    return percent + '%';
};
var defaultCircle = {
    radius: 70,
...
var ResumeProfileComponent = /** @class */ (function () {
    function ResumeProfileComponent() {
    }
    ResumeProfileComponent.prototype.ngOnInit = function () {
    };
...
var ResumeSkillsComponent = /** @class */ (function () {
    function ResumeSkillsComponent() {
        this.skills = [
